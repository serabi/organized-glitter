/**
 * Unified logging system with security, performance monitoring, and specialized loggers
 * Consolidates all logging functionality into a single, secure system
 * @author @serabi
 * @created 2025-08-01
 */
 ...
 */
const createPerformanceLogger = (namespace: string) => {
...
// Default logger instance - maintains backward compatibility
const logger = createLogger();
const secureLogger = createLogger();

// Pre-created specialized loggers for common use cases
const authLogger = createLogger('AUTH');
const apiLogger = createLogger('API');
const dbLogger = createLogger('DATABASE');
const uiLogger = createLogger('UI');

// Export all logging functionality from a single source
export {
...
// Maintain compatibility with legacy import patterns
