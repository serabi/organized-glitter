...
export const useRandomizerStore = create<RandomizerState>()(
  persist(
    (set, get) => ({
      ...
      getSelectedProjects: () => {
        const state = get();
        return state.availableProjects.filter(project => 
      ...
      actions: {
        ...
        toggleProjectSelection: (projectId) => set((state) => {
        ...
        selectProjectsByIds: (projectIds) => set((state) => {
        ...
        // Spin management
        setLastSpinResult: (project) => set((state) => {
          if (project) {
        ...
        setSpinning: (spinning) => set((state) => {
        ...
        setWheelRotation: (rotation) => set((state) => ({
          ...state,
          wheelRotation: rotation,
        })),
        
        clearLastResult: () => set((state) => {
        ...
        // History management
        setSpinHistory: (history) => set((state) => {
        ...
        addSpinToHistory: (spin) => set((state) => {
        ...
        toggleShowHistory: () => set((state) => ({
          ...state,
          showHistory: !state.showHistory,
        })),
        
        setShowProjectSelector: (show) => set((state) => ({
          ...state,
          showProjectSelector: show,
        })),
        
        toggleShowProjectSelector: () => set((state) => ({
          ...state,
          showProjectSelector: !state.showProjectSelector,
        })),
        
        // Loading state management
        setLoadingProjects: (loading) => set((state) => ({
          ...state,
          isLoadingProjects: loading,
        })),
        
        setLoadingHistory: (loading) => set((state) => ({
          ...state,
          isLoadingHistory: loading,
        })),
        
        setCreatingSpin: (creating) => set((state) => ({
          ...state,
...
export const useSelectedProjects = () => 
  useRandomizerStore((state) => state.getSelectedProjects());

/** Hook to get only the statistics */
export const useRandomizerStats = () => 
  useRandomizerStore((state) => state.getStats());
...
export const useRandomizerPreferences = () => 
  useRandomizerStore((state) => state.preferences);

/** Hook to get all actions */
export const useRandomizerActions = () => 
  useRandomizerStore((state) => state.actions);