...
const MockDashboardFilters = vi.fn(() => <div data-testid="dashboard-filters">Dashboard Filters</div>);
...
describe('CollapsibleDashboardFilters', () => {
  ...
  describe('icon display', () => {
    ...
    it('should show down chevron when expanded', () => {
      ...
      const button = screen.getByRole('button');
      const chevronDown = button.querySelector('[data-testid="chevron-down"]') || 
